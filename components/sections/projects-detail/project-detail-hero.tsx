...
export function ProjectDetailHero({ title, image }: ProjectDetailHeroProps) {
  return (
    <section className="relative overflow-hidden" aria-labelledby="project-detail-hero-heading">
      ...
      <Container className="relative z-10 py-20 sm:py-24">
        ...
        <nav aria-label="Breadcrumb" className="mt-4">
          <ol className="flex items-center gap-3 text-sm text-white/95">
            ...
            <li aria-hidden>|</li>
            <li>
              <Link href="/projects" className="font-semibold transition-opacity hover:opacity-85">
                Projects
              </Link>
            </li>
          </ol>
